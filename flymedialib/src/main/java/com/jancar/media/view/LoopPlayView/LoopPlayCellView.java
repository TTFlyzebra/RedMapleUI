package com.jancar.media.view.LoopPlayView;
...
public class LoopPlayCellView extends BaseLoopPlayView {
    ...
    public void initView(int width, int height) {
        ...
        for (int i = 0; i <= mShowViewNum + 1; i++) {
            ...
            RelativeLayout.LayoutParams lp1 = new RelativeLayout.LayoutParams(mViewInfos[i].right - mViewInfos[i].left, mViewInfos[i].bottom - mViewInfos[i].top);
