...
//            boolean isSelect = key != null && key.equals(RecyclerCellView.this.itemKey);
...
//            });
//            try {
//                holder.itemView.setEnabled(!key.equals(RecyclerCellView.this.itemKey));
//            } catch (Exception e) {
//                FlyLog.e(e.toString());
//            }
...
//                                    }
//                                    try {
//                                        imageView.setColorFilter(key.equals(RecyclerCellView.this.itemKey) ? ThemeBean.filterColor : ThemeBean.normalColor);
//                                    } catch (Exception e) {
//                                        FlyLog.e(e.toString());
//                                    }
//                                    break;
